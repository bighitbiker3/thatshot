  ...
  render () {
    ...
    return (
      <div className='album-art-div'>
        ...
        <img style={style} onClick={() => this.props.upVoteTrack(this.props.track.id, this.props.user)} className='img-responsive album-art' src={this.props.track.artwork_url || '/images/jungleMan.jpg'} />
      </div>
    )
  }
}
